...
Вывод картинок кастомного размера
<?php add_image_size('name', 200, 200, true); ?>, где первый аргумент - название размера, второй и третий - сами размеры.

Фильтр для cf7, исключающий создание дополнительных тегов p и br внутри формы
<?php add_filter('wpcf7_autop_or_not', '__return_false'); ?>

Дополнительная функция, навешивающая на форму из cf7 необходимый класс
<?php html_class="contact-form" ?>
